...
void setup () {
  ...
  img2 = loadImage("mrkrabs.jpg");
  img3 = loadImage("flyingdutchman.jpg");
  img4 = loadImage("rockbottom.jpg");
  img5 = loadImage("painting.jpg");
  fill(0);
  font = createFont("Montague.ttf", 50);
  textFont(font); 
  gameState = "START";
...
//I got help froma  peer in my classroom regarding the concept of game 
...
// //This user defined function allows a person to go back to square one.
...
void startDollarCoins() {
  ...
  //as far as how it can be implemented into this sketch, I'm struggling in 
  //that regard.
}
